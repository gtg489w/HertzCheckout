...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(World.markerDrawable_idle, 5.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(World.markerDrawable_selected, 5.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(30), 1.2, {
        zOrder: 1,
        offsetY: 0.55,
        style: {
            textColor: '#FFFFFF',
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(30), 1.0, {
        zOrder: 1,
        offsetY: -0.55,
        style: {
            textColor: '#FFFFFF'
